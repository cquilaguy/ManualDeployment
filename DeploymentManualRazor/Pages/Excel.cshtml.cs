...
namespace DeploymentManualRazor.Pages
{
    public class ExcelModel : PageModel
    {
        ...
        //        worksheet.Cells["A2"].Value = Persona.Nombre;

        //        worksheet.Cells["B1"].Value = "Email";
        //        worksheet.Cells["B2"].Value = Persona.Email;

        //        worksheet.Cells["C1"].Value = "Edad";
        //        worksheet.Cells["C2"].Value = Persona.Edad;
...
namespace DeploymentManualRazor.Pages
{
    public class ExcelM : PageModel
    {

        private int currentRowIndex;

        public List<ChangeService> usuarios { get; set; }

        public changeInformationViewModel ChangeInformation { get; set; }
        private List<changeInformationViewModel> datosEnMemoria = new List<changeInformationViewModel>();


        private readonly ManualDeploymentContext _dbContext;
        public ExcelM(ManualDeploymentContext dbContext)
        {
        ...
        {
            // Obtener los datos del modelo ChangeInformationViewModel

            byte[] fileContents = GenerateExcelBytes();
        ...
        private byte[] GenerateExcelBytes()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var picture = worksheet.Drawings.AddPicture("imagen", new FileInfo("C:/Users/jebellof/Desktop/Manual Razor/DeploymentManualRazor/wwwroot/Images/logo-social.png"));
                ...
                for (int i = 0; i < newRowCount; i++)
                {
                    ...
                    foreach (var value in datosEnMemoria)
                    {
                        worksheet.Cells["C7:E7"].Value = value.RequesType;
