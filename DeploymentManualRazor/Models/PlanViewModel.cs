...
namespace DeploymentManualRazor.Models
{
    public class PlanViewModel
    {
        ...
        public List<Plan> Planss { get; set; }
        public List<User> Users { get; set; }

        public PlanViewModel(ManualDeploymentContext dbContext)
        {
            _dbContext = dbContext;
            Planss = new List<Plan>();
        ...
        public void GetPlan()
        {
            if (ChangeID != 0)
            {
                ...
                Planss = _dbContext.Plan.Where(b => b.ChangeID == ChangeID).ToList();
